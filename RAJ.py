...
TOKEN = '7258733018:AAGxCaThUukOoL5kueCIELn1SrCf0TBtSjw'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002417246443
CHANNEL_ID = -1002417246443
error_channel_id = -1002417246443
...
def process_attack_command(message):
    try:
        ...
        if target_port in blocked_ports:
            ...
            return
        if duration >= 2000:
            bot.send_message(message.chat.id, "*⏳ Maximum duration is 2000 seconds.*\n"  # Duration limit message
